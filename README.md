...
<p align="justify">No projeto desenvolvi uma aplicação web baseada em um aplicativo de delivery de comida onde o design foi desenvolvido pela designer Camila Mizutani e utilizamos uma API própria contendo todas as funções necessárias.</p>


<!-- PROJECT SITE -->
<h2 id="site">:earth_americas: Link do site </h2>
<p>🔗 <a href="https://chilly-battle.surge.sh/" target="_blank"> Future Eats </a>  </p>
<!-- <a href="https://chilly-battle.surge.sh/" onclick="return ! window.open(this.href);"> Open in a new window</a> -->
...
<p>🔗 <a href="https://mui.com/pt/" target="_blank"> Chakra </a> - O Chakra fornece um componente opcional CssBaseline. Ele corrige algumas inconsistências nos navegadores e dispositivos, ao mesmo tempo em que fornece redefinições ligeiramente mais opinativas para elementos HTML comuns.</p>
